    ...
    <div className="group inline-block">
      ...
      <ul className="z-10 bg-white border rounded-sm transform scale-0 group-hover:scale-100 absolute transition duration-150 ease-in-out origin-top min-w-32">
        <li className="cursor-pointer px-3 py-1 hover:bg-gray-100">
          <Link to={`/home?page=${Number(providerParams)}&name=A-Z`}>
            User name A-Z
          </Link>
        </li>
        <li className="cursor-pointer px-3 py-1 hover:bg-gray-100">
          <Link to={`/home?page=${Number(providerParams)}&name=Z-A`}>
            User name Z-A
          </Link>
        </li>
        <li className="cursor-pointer px-3 py-1 hover:bg-gray-100">
          <Link to={`/home?page=${Number(providerParams)}&email=A-Z`}>
            Email A-Z
          </Link>
        </li>
        <li className="cursor-pointer px-3 py-1 hover:bg-gray-100">
          <Link to={`/home?page=${Number(providerParams)}&email=Z-A`}>
            Email Z-A
          </Link>
        </li>
